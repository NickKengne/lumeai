      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="flex items-center justify-center gap-12 flex-wrap">
            ...
            {/* Google */}
            <div className="flex items-center justify-center opacity-40 hover:opacity-90 transition-opacity cursor-pointer">
              <svg
                width="80"
                height="24"
                viewBox="0 0 272 92"
            ...
            <div className="flex items-center justify-center opacity-40 hover:opacity-90 transition-opacity cursor-pointer">
              <Image
                src="/meta-logo-facebook-2-svgrepo-com.svg"
                alt="Meta"
                width={50}
                height={24}
                className="dark:invert"
            ...
            <div className="flex items-center justify-center opacity-40 hover:opacity-90 transition-opacity cursor-pointer">
              <Image
                src="/microsoft-logo-svgrepo-com.svg"
                alt="Microsoft"
                width={100}
                height={24}
                className="dark:invert"
