...
/**
 * Different iPhone mockup variants for variety in layouts
 */

export type IphoneMockupVariant = 'default' | 'black' | 'minimal' | 'shadow'

export interface IphoneMockupVariantProps extends HTMLAttributes<HTMLDivElement> {
  src?: string
  videoSrc?: string
...
export function IphoneMockupVariant({
  src,
  videoSrc,
  variant = 'default',
  className,
  ...
  return (
    <div
      className={`relative inline-block w-full align-middle leading-none ${className || ''} ${variant === 'shadow' ? 'drop-shadow-2xl' : ''}`}
      style={{
    ...
    >
      ...
      >
        ...
        {/* Dynamic Island / Notch detail */}
        <path
          d="M154 48.5C154 38.2827 162.283 30 172.5 30H259.5C269.717 30 278 38.2827 278 48.5C278 58.7173 269.717 67 259.5 67H172.5C162.283 67 154 58.7173 154 48.5Z"
          fill={variant === 'black' ? '#0A0A0A' : '#F5F5F5'}
        />
        <path
        ...
        <path
          ...
          fill={variant === 'black' ? '#1A1A1A' : colors.frame}
        />
