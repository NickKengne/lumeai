  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-32">
        <div className="mb-16">
          <h1 className="text-6xl   tracking-tight text-neutral-900 mb-4">
            Terms of Service
          </h1>
        ...
        <div className="space-y-12">
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Use of Service</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Eligibility</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Account Registration</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Acceptable Use</h3>
                <p className="text-neutral-500   leading-relaxed mb-2">
                  You agree not to:
                </p>
                <ul className="list-disc list-inside space-y-1 text-neutral-500   leading-relaxed ml-4">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Content and Intellectual Property</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Your Content</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Generated Content</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Our Intellectual Property</h3>
                <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Payment and Billing</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Subscription Plans</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Refunds</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Cancellation</h3>
                <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Service Availability</h2>
            <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Limitation of Liability</h2>
            <p className="text-neutral-500   leading-relaxed mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW:
            </p>
            <ul className="list-disc list-inside space-y-2 text-neutral-500   leading-relaxed ml-4">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Indemnification</h2>
            <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Termination</h2>
            <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Changes to Terms</h2>
            <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Governing Law</h2>
            <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Contact Information</h2>
            <p className="text-neutral-500   leading-relaxed">
