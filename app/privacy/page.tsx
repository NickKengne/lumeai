    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-32">
        ...
        <div className="space-y-12">
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Introduction</h2>
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Information We Collect</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Account Information</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Screenshots and Content</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Usage Data</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">Technical Data</h3>
                <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Data Storage and Security</h2>
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Third-Party Services</h2>
            <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Your Rights</h2>
            <p className="text-neutral-500   leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Cookies and Tracking</h2>
            <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Children's Privacy</h2>
            <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Changes to This Policy</h2>
            <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl   text-neutral-900 mb-4">Contact Us</h2>
            <p className="text-neutral-500   leading-relaxed">
