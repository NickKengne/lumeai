...
export default function APIDocsPage() {
      ...
      <div className="max-w-5xl mx-auto px-6 py-32">
        ...
        <div className="space-y-12">
          ...
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Authentication</h2>
          ...
          {/* Base URL */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Base URL</h2>
          ...
          {/* Generate Screenshot */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Generate Screenshot</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">POST /screenshots/generate</h3>
                <p className="text-neutral-500   leading-relaxed mb-4">
                  Generate App Store screenshots from uploaded images.
                </p>
                
                <h4 className="text-lg   text-neutral-900 mb-2 mt-4">Request Body</h4>
  ...
  "export_sizes": ["6.7", "6.5", "ipad"]
                ...
                <h4 className="text-lg   text-neutral-900 mb-2 mt-4">Response</h4>
                <div className="bg-neutral-900 text-neutral-50 p-4 font-mono text-sm mb-4 overflow-x-auto">
                  <pre>{`{
  "id": "gen_1234567890",
  "status": "completed",
  ...
  "created_at": "2025-01-15T10:30:00Z"
          ...
          {/* Generate Video */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Generate Video</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">POST /videos/generate</h3>
                <p className="text-neutral-500   leading-relaxed mb-4">
  ...
  "estimated_completion": "2025-01-15T10:35:00Z"
          ...
          {/* Analyze Screenshot */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Analyze Screenshot</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">POST /screenshots/analyze</h3>
                <p className="text-neutral-500   leading-relaxed mb-4">
  ...
  "suggested_templates": ["centered_bold", "offset_left"]
          ...
          {/* Get Job Status */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Get Job Status</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-2">GET /jobs/{`{job_id}`}</h3>
                <p className="text-neutral-500   leading-relaxed mb-4">
  ...
  "error": null
          ...
          {/* Rate Limits */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Rate Limits</h2>
            <div className="space-y-4">
              <p className="text-neutral-500   leading-relaxed">
          ...
          {/* Error Handling */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Error Handling</h2>
            <div className="space-y-4">
              <p className="text-neutral-500   leading-relaxed">
  ...
  "error": {
    ...
    "details": {...}
          ...
          {/* SDKs */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">SDKs and Libraries</h2>
            <div className="space-y-4">
              <p className="text-neutral-500   leading-relaxed">
          ...
          {/* Support */}
          <section>
            <h2 className="text-3xl   text-neutral-900 mb-6">Support</h2>
            <div className="space-y-4">
              <p className="text-neutral-500   leading-relaxed">
                Need help with the API?
              </p>
              <div className="space-y-2">
                <a href="mailto:api@lumeai.com" className="block text-neutral-600   hover:text-neutral-900 transition-colors">
                  → Email: api@lumeai.com
                </a>
                <a href="https://github.com/lumeai/api-examples" className="block text-neutral-600   hover:text-neutral-900 transition-colors">
