      ...
      <div className="max-w-5xl mx-auto px-6 py-32">
        ...
        <div className="space-y-12">
          ...
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Getting Started</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-3">Quick Start</h3>
          ...
          {/* Features */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Features</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-3">AI-Powered Analysis</h3>
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-3">Template Library</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-3">Interactive Canvas</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-3">Video Generation</h3>
                <p className="text-neutral-500   leading-relaxed">
          ...
          {/* Export Sizes */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Export Sizes</h2>
          ...
          {/* Best Practices */}
          <section className="border-b border-neutral-200 pb-12">
            <h2 className="text-3xl   text-neutral-900 mb-6">Best Practices</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl   text-neutral-900 mb-3">Screenshot Quality</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-3">Headlines</h3>
                <p className="text-neutral-500   leading-relaxed">
              ...
              <div>
                <h3 className="text-xl   text-neutral-900 mb-3">Visual Consistency</h3>
                <p className="text-neutral-500   leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Link href="/dashboard" className="block text-neutral-600   hover:text-neutral-900 transition-colors">
                  → Start creating in the dashboard
                </Link>
                <Link href="/pricing" className="block text-neutral-600   hover:text-neutral-900 transition-colors">
                  → View pricing plans
                </Link>
                <a href="mailto:support@lumeai.com" className="block text-neutral-600   hover:text-neutral-900 transition-colors">
